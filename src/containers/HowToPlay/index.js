...
const howToPlay = (props) => (
  <div className={classes.MainDiv}>
    ...
    <p>O malvado Wumpus <img src={wumpus} alt="Wumpus"/> está se escondendo em algum lugar na caverna. Se você entrar no quadrado do Wumpus, ele irá te comer. O Wumpus pode ser detectado em quadrados adjacentes. Você pode matar o Wumpus atirando uma flecha (flecha aqui) na direção dele.</p>
